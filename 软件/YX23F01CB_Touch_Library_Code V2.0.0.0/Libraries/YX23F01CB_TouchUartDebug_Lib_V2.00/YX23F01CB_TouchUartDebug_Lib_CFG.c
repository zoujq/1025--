...
#include "YX23F01CB_TouchUartDebug_Lib_V2.00\YX23F01CB_TouchUartDebug_Lib_Build_Message.h"
#else
...
#error		"触摸调试管脚设置错误，请在YX23F01CB_TouchUartDebug_Lib_CFG.h文件中重新配置TouchUartDebugLib_TXD_Px_y"
#endif
